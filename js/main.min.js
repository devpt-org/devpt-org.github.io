...
(function(){useLightMode();const breadcrumbLinks=document.querySelectorAll('a[data-breadcrumb]');[...breadcrumbLinks].forEach((anchor)=>decodeURIFromBreadcrumb(anchor,anchor.getAttribute('data-breadcrumb')));})();